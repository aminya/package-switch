...
export default Bundles = (function() {
    Bundles = class Bundles {
      static initClass() {
        this.prototype.filename = null;
        this.prototype.data = {};
        this.prototype.single_bundles = {};
        this.prototype.project_bundles = {};
        this.prototype.writing = false;
      }
      ...
      setData(emit = true) {
        if (this.filename != null) {
          try {
            ...
            if (emit) { return this.emitter.emit('file-change'); }
          } catch (error) {
      ...
      replaceBundle(oldname, name, packages) {
        if (((oldname === name) && (this.data[oldname] != null)) || ((this.data[oldname] != null) && (this.data[name] == null))) {
          ...
          if (!this.data[oldname]) { this.notify(`Bundle \"${oldname}\" not found`); }
          if (this.data[name] != null) { return this.notify(`Bundle \"${name}\" already exists`); }
        }
      }
      ...
      getBundles(singles = true) {
        ...
        for (let project of atom.project.getPaths()) {
          ...
          if (fs.existsSync((f = path.join(project, '.package-switch.cson')))) {
            var d, i;
            if (InitFile == null) { InitFile = require('./init-file'); }
        ...
        Object.keys(this.single_bundles).forEach(key => {
          if ((this.data[key] == null)) { return p.push({
            name: key,
